...
ClickHouse and S3 backends. There are no Rust integration test files -- all 65 tests
(T1-T63 plus sub-tests) live in `test/run_tests.sh`.

```
test/
├── run_tests.sh                  # Integration test runner with 65 tests
